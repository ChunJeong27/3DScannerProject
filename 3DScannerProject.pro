...
win32 | linux-g++ | linux-g++-64 | linux-g++-32 {
...
-lopencv_barcode -lopencv_bgsegm -lopencv_bioinspired -lopencv_ccalib \
-lopencv_dnn_objdetect -lopencv_dnn_superres -lopencv_dpm -lopencv_face \
-lopencv_freetype -lopencv_fuzzy -lopencv_hfs -lopencv_img_hash \
...
-lopencv_sfm -lopencv_stereo -lopencv_structured_light \
...
-lopencv_videoio -lopencv_viz -lopencv_wechat_qrcode -lopencv_xfeatures2d \
-lopencv_shape -lopencv_ml -lopencv_ximgproc -lopencv_video -lopencv_xobjdetect \
...
LIBS += $$(LDFLAGS) `pkg-config --libs opencv4`
